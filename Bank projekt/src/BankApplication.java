...
public class BankApplication {
	...
	private void deposit() {
		...
		System.out.print(account + "(Belopp: " + account.getAmount() + ")");
	}
	...
	private void transfer() {
		...
		System.out.println(fromAccount + "(Belopp: " + fromAccount.getAmount() + ")");

		System.out.println(toAccount + "(Belopp: " + toAccount.getAmount() + ")");
	}
	...
	private void printAccounts() {
		...
		accs.forEach(acc -> System.out.println(acc + "(Belopp: " + acc.getAmount() + ")"));
	}
